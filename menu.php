...
<head>
    ...
    <style>
        /* --- INLINED STYLES FOR MENU PAGE --- */
        .menu-section { padding: 60px 0; background-color: #f8f8f8; }
        .section-heading { font-family: 'Mada', sans-serif; text-align: center; margin-bottom: 60px; color: #222; font-weight: 700; line-height: 1.2; font-size: clamp(2rem, 5vw + 1rem, 2.8rem); }
        .menu-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 40px; background-color: #fff; border-radius: 10px; box-shadow: 0 5px 15px rgba(0, 0, 0, 0.05); padding: 15px 25px; flex-wrap: wrap; gap: 15px; position: relative; }
        ...
        .category-btn .btn-text { margin-left: 8px; }
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (categoryButtonsContainer && swipeIndicator) {
                // Hide swipe indicator after first scroll/touch
            ...
            // --- The rest of your filterAndSort and other menu logic remains unchanged ---
